...
function validateForm(theForm) {
   with(theForm) {
      return (isNotEmpty(txtName, "Adınızı giriniz!", elmNameError)
           && isNumeric(txtZipcode, "5 haneli posta kodunuzu giriniz!", elmZipcodeError)
           && isLengthMinMax(txtZipcode, 5, 5, "5 haneli posta kodunuzu giriniz!", elmZipcodeError)
           && isSelected(selCountry, "Lütfen bir seçim yapınız!", elmCountryError)
           && isChecked("gender", "Lütfen cinsiyetinizi seçiniz!", elmGenderError)
           && isNumeric(txtPhone, "Lütfen geçerli bir numara giriniz!", elmPhoneError)
           && isValidEmail(txtEmail, "lütfen geçerli bir e-posta giriniz!", elmEmailError)
      );
   }
}
